...
public class InRoom4Activity extends AppCompatActivity {
    ...
    private TextView doc1,queue1,name1,gen1,blood1,birth1,weigh1,height1,cau1,pstate1,phone1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_in_room4);
        bind();
        //pageManage();
    }
    ...
    protected void onStart() {
        ...
        if(mUser == null){
            startActivity(new Intent(InRoom4Activity.this,MainActivity.class));
            finish();
        }
        pageManage();
    }
    ...
    private final View.OnClickListener  onClickListener = new View.OnClickListener(){
        ...
        public void onClick(View v) {
            switch (v.getId()){
                ...
                case R.id.cured_room4:
                    curedPatient();
                    Toast.makeText(InRoom4Activity.this, "Cured This Patient", Toast.LENGTH_SHORT).show();
                ...
                case R.id.choose_room4:
                    startActivity(new Intent(getApplicationContext(),Room4ChooseActivity.class));
                    break;

                case R.id.refresh_room4:
                    mReadRoomQueue();
    ...
    private void bind(){
        doc1 = findViewById(R.id.doctor_room4);
        queue1 = findViewById(R.id.queue_room4);
        name1 = findViewById(R.id.name_room4);
        gen1 = findViewById(R.id.gend_symb4);
        birth1 = findViewById(R.id.birth_room4);
        blood1 = findViewById(R.id.blood_room4);
        weigh1 = findViewById(R.id.weight_room4);
        height1 = findViewById(R.id.height_room4);
        cau1 = findViewById(R.id.caution_room4);
        pstate1 = findViewById(R.id.pstate_room4);
        phone1 = findViewById(R.id.phone_room4);

        exitB = findViewById(R.id.exit_room4);
        enterB = findViewById(R.id.enter_room4);
        curedB = findViewById(R.id.cured_room4);
        findNextB = findViewById(R.id.findNext_room4);
        chooseB = findViewById(R.id.choose_room4);
        refB = findViewById(R.id.refresh_room4);
    ...
    private void pageManage(){
        ...
        mRoom1 = mDatabase.getReference("Clinic").child("rooms").child("4");
        mOfficers = mDatabase.getReference("Officers");
        mAllQueue = mDatabase.getReference("Clinic").child("Bqueues");
            ...
            for (int i = 0; i < patientKeys.size(); i++) {
                if (patientKeys.get(i).equals(patientID.get(0))) {
                    ...
                    if (thisStatus.get(roomQ.get(0)-1).toString().equals("waiting") && isInRoomSet == false) {
                        manualReadAllQueue();
                        mAllQueue.child(String.valueOf(roomQ.get(0))).child("status").setValue("inRoom4");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot node : dataSnapshot.getChildren()){
                    if(node.child("status").exists()){
                        if(node.child("status").getValue().toString().equals("inRoom4")){
    ...
    private void curedPatient(){
        ...
        if(thisStatus.get(roomQ.get(0)-1).toString().equals("inRoom4")){
            mReadPatientID();
        ...
        mAllQueue.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(waitingList.isEmpty()){
                    Toast.makeText(InRoom4Activity.this, "Don't have any Waiting Patient now", Toast.LENGTH_SHORT).show();
                }else{
                    ...
                    if(oldPatient > 0) {
                        if (thisStatus.get(oldPatient-1).toString().equals("inRoom4")) {
    ...
    private void setOfficerRoom(){
        mOfficers.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot node : dataSnapshot.getChildren()){
                    if(node.child("status").exists()){
                        if(node.child("status").equals("Room4")){
                            mOfficers.child(node.getKey()).child("status").setValue("idle");
                        }
                    }
                    if(node.getKey().equals(mUser.getUid())){
                        mOfficers.child(node.getKey()).child("status").setValue("Room4");
                    }
                }
            }
